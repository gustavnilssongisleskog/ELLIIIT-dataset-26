...
#EXTRA SAVE TO HAVE SEPERATE DATA
#TODO if new run change!
np.save(save_loc+'trad_positioning_data_all_anchors\\other_data\\rangingfault_all.npy', ranging_faults)
np.save(save_loc+'trad_positioning_data_all_anchors\\other_data\\d_meas_matrix.npy', d_meas_matrix)
...
np.save(path_estimation_data+'output_data_trad_all_mn_locations.npy', estimation_data_all)

#TODO extra save seperate dir
np.save(save_loc+'trad_positioning_data_all_anchors\\output_data_trad_all_mn_locations.npy', estimation_data_all)